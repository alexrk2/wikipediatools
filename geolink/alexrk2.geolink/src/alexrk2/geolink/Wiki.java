...
public class Wiki implements Serializable
{
    ...
    public LinkedHashMap<String, String> getSectionAnchors(String page) throws IOException
    {
        ...
        while (line.contains("<s "))
        {
            ...
            // section number
            a = line.indexOf("anchor=") + 8;
            b = line.indexOf("\"", a);
            String anchor = line.substring(a, b);
 
            map.put(title, anchor);
